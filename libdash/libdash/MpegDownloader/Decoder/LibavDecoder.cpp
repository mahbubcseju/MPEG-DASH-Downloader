...
AVFormatContext*    LibavDecoder::OpenInput               ()
{
   ...
   std::cout<<"Enter av open frst"<<std::endl;
    err = avformat_open_input(&avFormatContextPtr, "", NULL, NULL);

    if (err < 0)
    {

        std::cout<<"Error while calling avformat_open_input1"<<std::endl;
    ...
    //std::cout<<"Enter av open "<<std::endl;
    if (err < 0)
    {

        std::cout<<"Enter av open 2"<<std::endl;
