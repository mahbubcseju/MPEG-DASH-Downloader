...
void        MultimediaStream::Init                      ()
{
    ...
    this->frameBuffer   = new Buffer<cv::Mat>(this->frameBufferSize, libdash::framework::buffer::VIDEO);
...
void        MultimediaStream::AddFrame                  (cv::Mat *frame)
{
    this->frameBuffer->PushBack(frame);
}
Mat*   MultimediaStream::GetFrame                  ()
{
